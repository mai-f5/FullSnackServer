...
Project.belongsToMany(User, { as: 'user_id_users', through: UserLike, foreignKey: "liked_project_id", otherKey: "user_id" });
Project.belongsToMany(RequiredTech, { as: 'tech_id_required_teches', through: ProjectTech, foreignKey: "project_id", otherKey: "tech_id" });
...
Project.hasMany(ProjectTech, { as: "project_teches", foreignKey: "project_id" });
...
Project.hasMany(UserLike, { as: "users_liked_projects", foreignKey: "liked_project_id" });
...
User.hasMany(UserLike, { as: "users_liked_projects", foreignKey: "user_id" });
